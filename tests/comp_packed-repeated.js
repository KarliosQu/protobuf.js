...
tape.test("packed repeated values", function(test) {
    ...
    test.same(Test2.toObject(dec1), msg, "should decode packed even if defined non-packed");
    var dec2 = Test1.decode(Test2.encode(msg).finish());
    test.same(Test1.toObject(dec2), msg, "should decode non-packed even if defined packed");
