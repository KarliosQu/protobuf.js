...
tape.test("configure a custom encoder/decoder for bytes", function(test) {
    console.log("DEBUG: require.resolve('..') =", require.resolve(".."));
    var oldBuffer = protobuf.util.Buffer;

    protobuf.util.Buffer = CustomBuffer;
    console.log("DEBUG: protobuf.Writer is", protobuf.Writer);
    console.log("DEBUG: protobuf.Writer.IS_RUST =", protobuf.Writer.IS_RUST);
    console.log("DEBUG: protobuf.Writer._configure is", protobuf.Writer._configure);
    protobuf.configure();
