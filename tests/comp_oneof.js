...
tape.test("oneofs", function(test) {
    ...
    console.log("DEBUG: keys", Object.keys(message));
    console.log("DEBUG: str", message.hasOwnProperty("str"), message.str);
    console.log("DEBUG: num", message.hasOwnProperty("num"), message.num);
    console.log("DEBUG: other", message.hasOwnProperty("other"), message.other);
    console.log("DEBUG: enm", message.hasOwnProperty("enm"), message.enm);
