...
tape.test("google.protobuf.Any", function(test) {
    ...
    test.same(Any.toObject(foo.foo), { type_url: "Bar", value: [10, 1, 97] }, "should keep explicit Any in fromObject properly");
    ...
    test.same(Any.toObject(foo.foo), { type_url: "/Bar", value: protobuf.util.newBuffer([10, 1, 97]) }, "should have correct Any object when converted with fromObject");
