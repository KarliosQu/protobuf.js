...
tape.test("reflected enums", function(test) {
    ...
    enm.add("c", 3);
    test.same(Object.assign({}, enm.values), {
        a: 1,
        b: 2,
        c: 3
    }, "should allow adding new values");
    test.same(Object.assign({}, enm.valuesById), {
        1: "a",
        2: "b",
        3: "c"
    ...
    var json = enm.toJSON();
    json.values = Object.assign({}, json.values);
    test.same(json, {
        values: {
            a: 1,
            c: 3
    ...
    test.same( Object.assign({}, enm_allow_alias.values), {
      a: 0,
      b: 0
    });
